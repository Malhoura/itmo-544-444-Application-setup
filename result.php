...
$sql = "INSERT INTO User (username, useremail, telephone, finisheds3url, raws3url, filename, state, datetime) VALUES('".$username."','".$useremail."','".$telephone."','".$url_thumb."','".$url."','".$userfile["name"]."','2','NOW()')";
